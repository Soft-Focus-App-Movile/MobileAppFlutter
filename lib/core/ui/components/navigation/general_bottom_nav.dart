...
class GeneralBottomNav extends StatelessWidget {
        ...
        child: NavigationBar(
          ...
          destinations: [
            _buildNavItem(
              ...
              label: 'Inicio',
              isSelected: currentPath == '/general_home' || currentPath == AppRoute.home.path,
            ),
            _buildNavItem(
            ...
            _buildNavItem(
              ...
              label: 'IA',
              isSelected: currentPath == AppRoute.aiWelcome.path,
            ),
            _buildNavItem(
            ...
            _buildNavItem(
              ...
              label: 'Perfil',
              isSelected: currentPath == AppRoute.generalProfile.path,
            ),
          ],
        ),
      ),
  ...
  int _getSelectedIndex(String currentPath) {
    if (currentPath == '/general_home' || currentPath == AppRoute.home.path) return 0;
    if (currentPath == AppRoute.diary.path) return 1;
    if (currentPath == AppRoute.aiWelcome.path) return 2;
    if (currentPath == AppRoute.library.path) return 3;
    if (currentPath == AppRoute.generalProfile.path) return 4;
    return 0;
  }
  ...
  void _onItemTapped(BuildContext context, int index) {
    switch (index) {
      ...
      case 1:
        ...
        break;
      case 2:
        // TODO: AI team - implement navigation
        context.go(AppRoute.aiWelcome.path);
        break;
      case 3:
      ...
      case 4:
        ...
        context.go(AppRoute.generalProfile.path);
        break;
    }
  }
}
