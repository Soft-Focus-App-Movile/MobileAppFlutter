...
class _PatientScaffoldState extends State<PatientScaffold> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      bottomNavigationBar: _PatientBottomNavInternal(
      ...
      body: IndexedStack(
        ...
        children: [
          ...
          _buildDiaryPage(),
          _buildPsychologistChatPlaceholder(),
          const LibraryPage(),
          _buildProfilePage(),
        ],
      ),
  ...
  Widget _buildPsychologistChatPlaceholder() {
    return Scaffold(
...
class _PatientBottomNavInternal extends StatelessWidget {
  final int currentIndex;
  final Function(int) onTap;

  const _PatientBottomNavInternal({
